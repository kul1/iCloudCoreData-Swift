...
@objc class PersistentStack: NSObject {
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = NSBundle.mainBundle().URLForResource("Noter", withExtension: "momd")!
  ...
  lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
    ...
    let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Noter.sqlite")
    NSLog("storeURL:\(url)")
    var error: NSError? = nil
      ...
      error: &error) == nil
    {
      ...
      error = NSError(domain: "Pendo_Error_Domain", code: 9999, userInfo: dict)
